  ...
  describe '.connector_for_client' do
    ...
    context 'Protobuf.connector_type is socket' do
      it 'returns a socket connector class' do
        ...
        described_class.connector_for_client.should eq ::Protobuf::Rpc::Connectors::Socket
      end
    end
    ...
    context 'Protobuf.connector_type is evented' do
      it 'returns an eventmachine connector class' do
        ...
        described_class.connector_for_client.should eq ::Protobuf::Rpc::Connectors::EventMachine
      end
    end
    ...
    context 'Protobuf.connector_type is zmq' do
      it 'returns a zmq connector class' do
        ...
        described_class.connector_for_client.should eq ::Protobuf::Rpc::Connectors::Zmq
      end
    end
