...
module Protobuf
  module Descriptor
    ...
    def self.type2id(type)
      require 'protobuf/descriptor/descriptor_proto'
      case type
      when :double then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_DOUBLE 
      when :float then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_FLOAT
      when :int64 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_INT64 
      when :unit64 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_UINT64 
      when :int64 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_INT32 
      when :fixed64 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_FIXED64 
      when :fixed32 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_FIXED32 
      when :bool then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_BOOL 
      when :string then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_STRING 
      when :group then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_GROUP 
      when :message then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_MESSAGE 
      when :bytes then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_BYTES
      when :uint32 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_UINT32 
      when :enum then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_ENUM 
      when :sfixed32 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_SFIXED32 
      when :sfixed64 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_SFIXED64 
      when :sint32 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_SINT32 
      when :sint64 then ::Google::Protobuf::FieldDescriptorProto::Type::TYPE_SINT64 
      else
    ...
    class DescriptorBuilder
      ...
      def self.build(proto, opt={})
        acceptable_descriptor(proto).build(proto)
      end

      def self.acceptable_descriptor(proto)
